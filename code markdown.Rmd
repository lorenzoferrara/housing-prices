...
# dice togli: total rooms, total bedrooms, housing-median-age
```

## 4. tabella di collinearit?
...
# population*households non ? per nulla significativo
...
qqline( g$res )
# Andamento non rettilineo, l'ipotesi non ? verificata
...
qqline( g_star$res )
# Andamento non rettilineo, l'ipotesi ? verificata
...
qqline( g_C$res )
# Andamento quasi rettilineo, l'ipotesi non ? verificata
...
qqline( g_C_new$res )
# Andamento adeguatamente rettilineo, l'ipotesi ? verificata
